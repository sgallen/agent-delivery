...

{
  ...
  write_env AGENT_RESOLUTION_INTENT "$RESOLUTION_INTENT"
  write_env AGENT_DECISION_QUESTION "$DECISION_QUESTION"
  write_env AGENT_EXPECTED_RESOLUTION_CLASS "$EXPECTED_RESOLUTION_CLASS"
  write_env AGENT_EXPECTED_DISPOSITION "$EXPECTED_DISPOSITION"
  write_env AGENT_LANDING_EXPECTATION "$LANDING_EXPECTATION"
  write_env AGENT_RELEASE_EXPECTATION "$RELEASE_EXPECTATION"
