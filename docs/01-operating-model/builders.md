...
A **builder** is a person who helps turn customer understanding into shipped product value.

The term is intentionally broader than engineer, product manager, designer, researcher, QA, operator, or customer-success leader.

Specialties still matter. The point is not to erase them. The point is to stop treating the boundary around each specialty as the delivery system.

## What builders own

Builders remain accountable for the things agents should not own in isolation:
...
The old model often assigned responsibility by lane:
...
A good operating model should give builders more agency and more room for creative work.
